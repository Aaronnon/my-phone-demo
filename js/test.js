...
function setScreenAnimate(screenCls) {
  ...
  var isAnimateDone = false; // The status of all sub-elements under the current screen is DONE?

  screen.onclick = function () {
    // Initialize style, add init A A_init
    ...
    // Switch init of all animateElements -> done A A_done
    ...
    // Switch done -> init A A_init of all animateElements
